...
for k in range(len(bucket)):
    ...
    colors = cycle(['#eb3477', '#4934eb', '#ff7f0e', '#ffbb78', '#2ca02c', '#98df8a', '#d62728', '#ff9896', '#9467bd', '#c5b0d5', '#8c564b', '#c49c94', '#e377c2', '#f7b6d2', '#7f7f7f', '#c7c7c7', '#bcbd22', '#dbdb8d', '#17becf', '#9edae5'])
    for tri in bucket[k]:
        xs, ys = zip(*tri)
        xs = np.array(xs) + col
        ys = np.array(ys) + row
...
fig.savefig(f"polygon_15_quilt_6.pdf", dpi=1200, bbox_inches='tight')
print(f"Saved to polygon_15_quilt_6.pdf")
